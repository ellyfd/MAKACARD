const GAME_DATA = {
  orgUnits: [
    ...
    {
      id: "dpc",
      name: "DPC / 數位服飾與 3D 研發",
      tagline: "3D 內容、視覺驗證、樣衣數位化、跨地執行",
  ...
  orgDirectory: [
    { id: "leadership", unit: "exec", name: "管理層", members: ["alex"] },
    { id: "digital-product", unit: "exec", name: "數位產品創造處", members: ["elly", "vanessa"] },
    { id: "dpc-direct", unit: "dpc", name: "DPC / Elly 直屬線", members: ["alan", "andy"] },
    { id: "rd-center", unit: "dpc", name: "3D 研發中心", members: ["karen"] },
    { id: "digital-fashion-taipei", unit: "dpc", name: "數位服飾 / 台北", members: ["adia", "chieh", "debbie", "jean", "rou", "sixian", "yoko", "celia"] },
