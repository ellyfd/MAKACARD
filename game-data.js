const GAME_DATA = {
  orgUnits: [
    ...
    },
    {
      id: "tech-rd",
      name: "工務研發群",
      tagline: "開發暨技術處、工務處、運籌處與 3D 研發中心",
    ...
    },
    {
      id: "newbiz",
      name: "新事業發展群",
      tagline: "數位產品發展中心、智慧紡織發展中心、Portal:M / StyTrix",
  ...
  orgDirectory: [
    ...
    { id: "ops-it", unit: "ops-mgmt", name: "資訊處 / 財會管理處", members: ["benjamin-hsieh", "christine-wen"] },
    { id: "dev-tech", unit: "tech-rd", name: "開發暨技術處", members: ["celia-hsu", "lillian-lin", "teresa-hsueh", "artie-yu", "sylvia-chou"] },
    { id: "rd-3d", unit: "tech-rd", name: "3D研發中心", members: ["elly", "karen", "adia", "yoko", "debbie", "chieh", "sixian", "rou", "jean", "yota", "jan", "huihui", "tinley", "rock"] },
    { id: "engineering-office", unit: "tech-rd", name: "工務處 / 運籌處", members: ["anne-hu", "brian-lin", "evy-chen"] },
    { id: "digital-product", unit: "newbiz", name: "數位產品發展中心", members: ["elly", "alan", "andy", "vanessa", "doris", "emily", "dianne"] },
  ...
  members: [
    ...
    },
    {
      ...
      name: "Alan Liu",
      role: "資深3D技師",
      department: "數位產品發展中心 / Line 1 產品3D",
      orgUnit: "newbiz",
      birthday: "1992-01-31",
      numerology: 8,
      element: "水",
    ...
    },
    {
      ...
      name: "Dianne Chen",
      role: "行銷專員",
      department: "數位產品發展中心 / Line 2 行銷專案",
      orgUnit: "newbiz",
      birthday: "1993-03-18",
      numerology: 7,
      element: "水",
